...
public class MyController {
	...
	public String UpdateCategoriesById(@PathVariable("di") int id, @RequestBody Category c1) {
	...
	public String UpdateProductByid(@PathVariable("di") int id, @RequestBody Product p1) {
